...
export const useNavCustomization = () => {
  ...
  // parent chain to wrongly highlight Home; searching the combined list finds the (rendered)
  // pinned node and stops there. Reference equality then highlights whichever row actually renders.
